<?php
$dataProvider = new CArrayDataProvider($informacionUsos, array(
	'keyField'=>'valor',
	'sort'=>array(
		'attributes'=>array(
			'contenido', 'valor',
...
$this->widget('bootstrap.widgets.TbGridView', array(
	...
	//'template' => "{items}",
    'id'=>'atributo-informacion-usos-asignados-grid',
		...
		array(
    		...
    		'buttons'=>array (
    			'update' => array (
    				...
    				'options'=>array(
    					'onClick'=>'callAjaxUpdateAttribute($(this).parent().parent().children(":nth-child(1)").text(), "atributo-informacion-usos-asignados-grid");',
    					'data-toggle' => 'modal',
