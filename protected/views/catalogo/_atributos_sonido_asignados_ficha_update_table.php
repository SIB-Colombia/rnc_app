<?php
$dataProvider = new CArrayDataProvider($sonido, array(
	'keyField'=>'valor',
	'sort'=>array(
		'attributes'=>array(
			'contenido', 'valor',
...
$this->widget('bootstrap.widgets.TbGridView', array(
	...
	//'template' => "{items}",
    'id'=>'atributo-sonido-asignados-grid',
		...
		array(
    		...
    		'buttons'=>array (
    			'update' => array (
    				...
    				'options'=>array(
    					'onClick'=>'callAjaxUpdateAttribute($(this).parent().parent().children(":nth-child(1)").text(), "atributo-sonido-asignados-grid");',
    					'data-toggle' => 'modal',
