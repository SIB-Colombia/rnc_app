...
<?php 
	...
	echo $this->renderPartial('_form', array('model'=>$model,'tamano_coleccion' => $tamano_coleccion, 'tipos_en_coleccion' => $tipos_en_coleccion, 'composicion_general' => $composicion_general, 'act' => 1, 'urls_registros' => $urls_registros)); 
?>
</div>