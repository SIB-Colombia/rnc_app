		...
		<div id="content">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			  	<ul>
			  		<li>Certificado de autodeclaración aplicación artículo 252 de la Ley 1753 de 2015  <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'button', 'type'=>'success','label'=>'Descargar','htmlOptions' => array('class'=>'btn btn-success btn-xs','onclick' => 'window.location="'.Yii::app()->createUrl("site/archivoInstructivo").'"')));?></li>
			  		<li>Plantilla de información asociada a los especímenes a registrar <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'button', 'type'=>'success','label'=>'Descargar','htmlOptions' => array('class'=>'btn btn-success btn-xs','onclick' => 'window.location="'.Yii::app()->createUrl("site/archivoAuto").'"')));?></li>
			  	</ul>
			  </div>
			</div>
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
			  	...
			  	<ul class="number-list">
			  		...
			  		<li>El procedimiento para la actualización del registro de las colecciones biológicas, incluyendo el material mencionado en el artículo 252, se realizará a través del sitio Web del RNC, disponible en http://rnc.humboldt.org.co, de acuerdo con lo establecido en la guía de registro o actualización de colecciones biológicas disponible en: http://rnc.humboldt.org.co/index.php/site/instructivo.</li>
			  	</ul>
			  	...
			  	<ul class="number-list">
			  		...
			  		<li>Certificado de autodeclaración de la información reportada ante el RNC con fecha de expedición no mayor a 3 meses a la fecha de envío de la solicitud de registro o actualización. Documento disponible en http://rnc.humboldt.org.co/index.php/site/instructivo</li>
			  		<li>Acreditación de la obtención del espécimen: durante el periodo de implementación del artículo 252, el titular de la colección expedirá una certificación en la que declare que el material recolectado obedece exclusivamente a proyectos de investigación científica y/o prácticas docentes universitarias, indicando el número total de especímenes por grupo biológico con la respectiva cobertura temporal: http://bit.do/autodeclaracion</li>
			  		<li>Deberá anexar una relación de todo el material a registrar, según los estándares para documentación de registros biológicos del Sistema de Información sobre Biodiversidad de Colombia (SiB Colombia): http://bit.do/plantilla-datos</li>
			  	</ul>
			  	...
			  	<p>La solicitud de aplicación del artículo 252 de la Ley 1753 de 2015 estará disponible hasta el 9 de junio de 2016.</p>
			  </div>
			</div>
		</div>
	</div>
