...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/themes/rnc_theme/server/php/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/temp_rnc/',
            'upload_url' => $this->get_full_url().'/temp_rnc/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
